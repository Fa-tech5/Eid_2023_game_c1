...
<script>
  ...
  export let qas = [];
  export let teamNames = ['الفريق 1', 'الفريق 2'];
  ...
  {:else}
    ...
    {#if end}
      <div class="row-center">
        <button on:click={restart}><span>إعادة</span></button>
      </div>
    {:else}
      {#if next}
    ...
    <br>
      ...
      {:else}
        ...
        {#if showPass}
          <button on:click={pass}><span>نتعدى؟<span></button>
        {/if}
      {/if}
    {/if}
  {/if}
...
<footer>
  <p>جميع الحقوق محفوظة لدى فاء التقنية<br>
  <a href="mailto:fa.technology5@gmail.com">fa.technology5@gmail.com</a> || <a href="https://salla.sa/fa-tech">https://salla.sa/fa-tech</a>
  </p>
</footer>